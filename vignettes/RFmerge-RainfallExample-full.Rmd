...
Using parallelisationin GNU/Linux machines, with a maximum number of nodes/cores to be used equal to 4:
```{r RFmergeWithLinuxParallelisation, eval = TRUE}
par.nnodes <- max(parallel::detectCores()-1, 4)
...
Using parallelisation in Window$ machines, with a maximum number of nodes/cores to be used equal to 4:
