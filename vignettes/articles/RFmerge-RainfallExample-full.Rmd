...
plot(ValparaisoDEM5km, main="SRTM-v4", 
     xlab="Longitude", ylab="Latitude", col=terrain.colors(255),
     fun=function() {lines(ValparaisoSHP) ; points(stations, pch=16, col="black") })
```
...
( eval.gis.utm <- terra::vect(eval.gis, geom=c("lon", "lat"), crs="epsg:4326") )
```
