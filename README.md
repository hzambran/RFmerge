...
[![GitHub package version (development)](https://img.shields.io/github/r-package/v/hzambran/RFmerge/master)](https://github.com/hzambran/RFmerge)
[![CRAN status](https://www.r-pkg.org/badges/version/RFmerge)](https://CRAN.R-project.org/package=RFmerge)
...
[![CRAN downloads (monthly)](https://cranlogs.r-pkg.org/badges/last-month/RFmerge)](https://cran.r-project.org/package=RFmerge)
...
Loading a shapefile with the location and metadata of ground observations:
...
Creating a new data.frame with the expected metadata, i.e., at least, ID, lat, lon:
...
>     url="https://doi.org/10.1016/j.rse.2019.111606",
>     pages = {111606}
>   }
...
>     year = "2026",
>     note = {R package version 0.3-0. doi:10.32614/CRAN.package.RFmerge},
...
* [RFmerge: Time Series Management, Analysis and Interpolation for Hydrological Modelling](https://github.com/hzambran/RFmerge).
